...
class Config:
    ...
    kl_divergence_weight: float = 1e-3
...
CFG["Conv"] = Config(
    ...
    window_size=32,
    measurement_downsampling=25,
)

CFG["LSTM"] = Config(
    model=ModelType.LSTMAE,
    model_cfg=LSTMAEConfig(hidden_size=128, num_layers=2, dropout=0, fc_hidden_sizes=[64], latent_sigmoid=True),
    features=["stat_coil_ph01_01_tmp"],
    window_size=16,
    measurement_downsampling=16,
)
